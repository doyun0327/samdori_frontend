...
import { COUNSELOR_BOOKINGS_PATH, COUNSELOR_REQUESTS_PATH, RESERVATION_PATH } from './paths'

export { COUNSELOR_BOOKINGS_PATH, COUNSELOR_REQUESTS_PATH, RESERVATION_PATH } from './paths'
